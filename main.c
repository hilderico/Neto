	...
	int x;
	int y;
	int comida_x[MAX_COMIDA];
	int comida_y[MAX_COMIDA];
	int comida = MAX_COMIDA;
	int salvacomida = 0;
	...
	int main()
	{
		...
		printf("salvacomida = %d\n",salvacomida);	
		int cont = 0;	

		comida_x[0] = seed0[63]; // 7
		comida_x[1] = seed0[15]; // 110
		comida_x[2] = seed0[2]; // 118
		comida_x[3] = seed0[8]; // 7
		comida_x[4] = seed0[120]; // 110
		comida_x[5] = seed0[73]; // 118
		comida_x[6] = seed0[87]; // 7
		comida_x[7] = seed0[1]; // 110
		comida_x[8] = seed0[89]; // 118
		comida_x[9] = seed0[21]; // 7
		
		comida_y[0] = seed1[17]; // 123
		comida_y[1] = seed1[93]; // 33
		comida_y[3] = seed1[18]; // 68
		comida_y[4] = seed1[29]; // 123
		comida_y[5] = seed1[2]; // 33
		comida_y[6] = seed1[90]; // 68
		comida_y[7] = seed1[126]; // 123
		comida_y[8] = seed1[9]; // 33
		comida_y[9] = seed1[3]; // 68
	...
	while((comida != 0) && (cont != 127))
	{
		...
		printf("comida = %d\n", comida);
		int contidx = 0;
		while(contidx != salvacomida)
		{
			printf("comida loc %d = (%d,%d)\n",contidx,comida_x[contidx], comida_y[contidx]);
		contidx++;
		}
		
		
	//	getchar();
		Destino(&x, &y, seed0[cont], seed1[127 - cont]);
		cont++;
	}
